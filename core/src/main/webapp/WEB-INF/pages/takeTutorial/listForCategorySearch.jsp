			...
			<table class=innertable>
				<tr>
					<td class="iconTd"></td>
			  		<td>
			  			<div class="title">
			  				<fmt:message key="page.takeTutorial.ID"/>${t.id}<div class="floatl tutorialName">${t.name}</div><div class="floatl tutor overhide"><fmt:message key="page.takeTutorial.Instructor"/><c:forEach items="${t.tutors}" var="tu" varStatus="stat">
