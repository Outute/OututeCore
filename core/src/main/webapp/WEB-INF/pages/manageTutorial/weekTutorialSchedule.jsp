...
<div class="week_schedule_<s:property value="#entry.key"/>">
	<s:iterator value="#entry.value" status="s" var="l">
		<div id="week_ts_<s:property value="#l['scheduleId']"/>" style="vertical-align:middle;font-size:10px;background-color:#F691B2;position:absolute;top:<s:property value="#l['fromMinute']*38/120"/>px;width:80px;height:<s:property value="(#l['toMinute']-#l['fromMinute'])*38/120"/>px; left:1px;overflow:hidden;" 
