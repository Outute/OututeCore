...
<div class="main-content" style="width: 100%;">
	...
	<input onclick="window.location.href='manageTutorials-Calendar.html';" name="viewtype_option" type="radio"  id="viewtype_option_1"/><label for="viewtype_option_1">Calendar View</label>
	<div id="tableTutorialAppointments">
		<h2>Tutorial Appointments</h2>
		<display:table name="tutorials" cellspacing="0" cellpadding="0" requestURI="" defaultsort="1" id="tutorials" pagesize="25" class="table" export="true">
			<display:column property="name" escapeXml="true" sortable="true" titleKey="tutorial.name" style="width: 25%" url="/editTutorial?from=list" paramId="id" paramProperty="id"/>
