...
<div class="day_schedule_<s:property value="#entry.key"/>">
	...
	<div id="day_ts_<s:property value="#l['scheduleId']"/>" style="vertical-align:middle;font-size:10px;background-color:#F691B2;position:absolute;top:<s:property value="#l['fromMinute']*38/120"/>px;width:120px;height:<s:property value="(#l['toMinute']-#l['fromMinute'])*38/120"/>px; left:<s:property value="#s.index*50"/>px;overflow:hidden;" 
