...
<div class="login_bg floatr">
  <div class="middle_right floatr">
    <div class="login-section">
      ...
      <div class="clear"></div>
      <div><a href="#">Forgot Password?</a><div class="clear"></div></div>
      <input type="image" src="images/login-button.gif" class="floatr" /><a href="register.html">Register Now!</a><div class="clear"></div>
    </div>
  </div>
</div>
